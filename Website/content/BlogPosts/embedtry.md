...
I attended an FCS school, and before looking into this data, I was much more familiar with that level of play and coach pay. My knowledge of FBS coach salaries was limited to what headlines I'd seen about Saban and Harbaugh. I was curious about trends in pay distribution and searched for a reliable source of data, finding one in USA Today. Since 2014, the publication has requested and released coach compensation data from all FBS schools.  Public schools are required to release such information, but private schools are exempt. Links to the data and methodology behind its collection are at the end of this post. Read on to learn a few things I found interesting about the data. 

#### Head Coach Salaries Across Conferences
-------------------------------------------------
First, let's take a look at head coach salaries. Below is a simple categorical scatterplot displaying head coach salaries by conference. Hovering over a point will reveal the corresponding coach, salary, and school. If you want to zoom in on a specific part of the plot (for example, to get a closer look at salaries in the MAC, which appear to be grouped very closely due to scaling), use your mouse to drag a box around the area. To zoom back out, double-click anywhere in the plot area. Please note that "Ind." does not represent a conference, but rather the limited data available from independent schools.  
...
The boxplots below illustrate the disparity in pay between Power Five and non-Power Five coaches. If you need a quick refresher on how to read boxplots, click [here](https://en.wikipedia.org/wiki/Box_plot). Otherwise, feel free to play around with the interactive plots. To zoom in on a specific area of the plot, drag a box around that area. To undo this action, double-click anywhere in the plot area. 

<iframe width="800" height="600" frameborder="0" scrolling="no" src="https://plot.ly/~rachehlers/143.embed"></iframe>

Like their head coaches, assistants in the SEC tend to earn more than those in other conferences. In 2017, seven of the top 9 assistant salaries went to SEC coaches. LSU's defensive coordinator, Dave Aranda, was the top-earning assistant, making $1.8 million. His defensive counterpart, Matt Canada, was fourth on the list with $1.505 million. Alabama and Michigan each employed a pair of assistants in the top 10 as well. 
...
The following plot consists of each school's head coach salary plotted against their staff's salaries totaled. Each blue point represents a non-Power Five head coach, and orange points represent Power Fives. I also included a line of equality for reference (where head coach salary would equal the staff total). The dropdown on the left allows you to switch what year's data is shown. Hovering over a point will reveal the corresponding coach, school, salary, and total staff salary. 
