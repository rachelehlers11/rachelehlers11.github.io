...
What about the rest of the staff? For years, each team has been allowed 9 paid assistant coaches. Starting in January, they'll be allowed 10. Curious about trends in salary distribution across teams and conferences, I began to search for a reliable source of data, finding one in USA Today. Since 2014, the publication has requested coaching staff compensation data from all FBS schools. Public schools are required to release such information, but private schools are exempt. Keep reading to learn more about participating schools. 


#### Head coaches make a lot. Power Five head coaches make a LOT. 
For each year from 2014-2017, about half of Power Five schools(those belonging to the ACC, Big 10, Big 12, Pac-12, and SEC) paid their head coach more than their 9 assistant salaries combined. This was only true for about 5% of schools not belonging to the Power Five 

The following plot consists of each school's head coach salary plotted against the school's assistant staff salaries summed. Each blue point represents a non-Power Five head coach, and orange points represent Power Fives. I also included a line of equality for reference (where head coach salary would equal the staff total). The dropdown on the left allows you to switch what year's data is shown. Hovering over a point will reveal the corresponding coach, school, salary, and total staff salary. 

<iframe width="800" height="600" frameborder="0" scrolling="no" src="https://plot.ly/~rachehlers/0.embed"></iframe>

#### Background
The FBS is made up of the Power Five, Group of Five, and independent schools. I will refer to the Group of Five and independent schools as "non-Power Five"

#### Power Five Conferences Dominate 
- Coaches in the Power Five conferences (Big 10, Big 12, Pac-12, ACC, and SEC) typically make more than those in other conferences. 
- Pay disparity between Power Five and non-Power Five teams are more prevalent at the head coach level.
- The top-paid head coaches are paid 
...
Each year from 2014-2017, about half of Power Five head coaches collected a salary greater than the combined salaries of their 9 assistants. Outside of the Power Five, usually only 3 or 4 coaches make more than their staff (about 5% per year). This can be seen on the plot above, in the points plotted to the right of the line of equality. 




<iframe width="425" height="425" frameborder="0" scrolling="no" src="https://plot.ly/~rachehlers/37.embed"></iframe>
<iframe width="425" height="425" frameborder="0" scrolling="no" src="https://plot.ly/~rachehlers/35.embed"></iframe>
